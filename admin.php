...
if(isset($_POST['add_book'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `books`(user_name, book_name, b_price, category,contact, image) VALUES('$admin_name','$p_name', '$p_price','$c_name','$p_contact', '$p_image')") or die('query failed');
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="admin.php?delete=<?php echo $row['bid']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="admin.php?edit=<?php echo $row['bid']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `books` WHERE bid = '$edit_id' ");
